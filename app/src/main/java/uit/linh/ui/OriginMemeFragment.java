...
public class OriginMemeFragment extends Fragment {

    private static final String TAG = "MemeDemoFragment";
    private static final String IMAGE_CACHE_DIR = "origin";
     ...
     * @return A new instance of fragment OriginMemeFragment.
     */
    public static OriginMemeFragment newInstance(String jString) {
        OriginMemeFragment fragment = new OriginMemeFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MemeRecycleViewAdapter(getActivity(), R.layout.meme_image_item, memeUrls, imageFetcher, new ItemHolder.IViewHolderClick() {
            ...
            public void OnImageClick(View caller, int position) {
                ...
                Intent intent = new Intent(getActivity().getBaseContext(), MemeCreator.class);
...
//        Log.e("bikini", "on pause");
    ...
    private void getMergerLink(JSONArray arr) throws JSONException {
        ...
        for (int i=0; i<arr.length(); i++){
            memeUrls.add(MainActivity.HOST + MainActivity.MEME_ORIGIN_PATH + arr.getJSONObject(i).getString("url"));
        }
    }
}
