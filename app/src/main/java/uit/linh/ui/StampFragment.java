...
public class StampFragment extends android.support.v4.app.Fragment {

    private static final String TAG = "StampFragment";
    private static final String IMAGE_CACHE_DIR = "stamps";
     ...
     */
    public static StampFragment newInstance(String jString) {
...
//        Log.e("bikini", "on pause");
    ...
    private void getMergerLink(JSONArray arr) throws JSONException {
        ...
        for (int i=0; i<arr.length(); i++){
            memeUrls.add(MainActivity.HOST + MainActivity.STAMPS_PATH + arr.getJSONObject(i).getString("url"));
        }
    }
}
